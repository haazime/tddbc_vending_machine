...
RSpec.describe VendingMachine do
  ...
  context "コーラの在庫がある場合" do
    ...
    [
      { money: Money.new([100, 10, 10]), pay_back: [], sales: 120 },
      { money: Money.new([100, 10, 10, 10]), pay_back: [10], sales: 120 },
      { money: Money.new([100, 50]), pay_back: [10] * 3, sales: 120 },
      { money: Money.new([500]), pay_back: [100] * 3 + [50] * 1 + [10] * 3, sales: 120 },
      { money: Money.new([1000]), pay_back: [500] * 1 + [100] * 3 + [50] * 1 + [10] * 3, sales: 120 },
    ].each do |c|
    ...
    context "110円を投入した時" do
      ...
      it do
        ...
        expect(machine.pay_back).to eq([100, 10])
  ...
  context "コーラの在庫がない場合" do
    [
      { money: Money.new([100, 10, 10]), pay_back: [100] * 1 + [10] * 2, sales: 0 },
      { money: Money.new([100, 10, 10, 10]), pay_back: [100] * 1 + [10] * 3, sales: 0 },
      { money: Money.new([100, 50]), pay_back: [100, 50], sales: 0 },
